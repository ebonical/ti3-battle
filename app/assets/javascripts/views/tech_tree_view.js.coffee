class ti3.TechTreeView extends Backbone.View
  el: ".section#techtree"
  ...
  initPlumbing: ->
    tech.initPlumbing() for tech in ti3.Technologies.models
  ...
  render: ->
    ...
    for tech in ti3.Technologies.models
      view = new ti3.TechnologyView(model: tech, parent: this)
